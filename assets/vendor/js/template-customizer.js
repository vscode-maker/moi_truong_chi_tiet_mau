    ...
    return (function () {
                            ...
                            (t.toString = function () {
                                return this.map(function (t) {
                                    ...
                                    return (
                                        ...
                                        i && (o += "@layer".concat(t[5].length > 0 ? " ".concat(t[5]) : "", " {")),
                                        (o += e(t)),
                                        i && (o += "}"),
                                        t[2] && (o += "}"),
                                        t[4] && (o += "}"),
                            ...
                            (t.i = function (e, o, i, n, a) {
                                ...
                                for (var c = 0; c < e.length; c++) {
                                    ...
                                    (i && s[u[0]]) ||
                                        ...
                                        n && (u[4] ? ((u[1] = "@supports (".concat(u[4], ") {").concat(u[1], "}")), (u[4] = n)) : (u[4] = "".concat(n))),
                                        t.push(u));
                                }
                            }),
                            t
                    ...
                    function i(e, i) {
                        for (var a = {}, s = [], r = 0; r < e.length; r++) {
                            ...
                            if (-1 !== m) t[m].references++, t[m].updater(p);
                                ...
                                var h = n(p, i);
                                (i.byIndex = r), t.splice(r, 0, { identifier: d, updater: h, references: 1 });
                            }
                            s.push(d);
                        }
                        return s;
        ...
        return (
            (function () {
                        ...
                        function e(t) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    n ? ((this.settings.defaultPrimaryColor = n), (z = !0)) : ((this.settings.defaultPrimaryColor = O.getPropertyValue("--bs-primary").trim()), (z = !1)),
                                    ...
                                    (this.settings.availableNavbarOptions = I || e.NAVBAR_OPTIONS),
                            ...
                            (o = [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        this._hasControls("layoutNavbarOptions") &&
                                            ((this.settings.layoutNavbarOptions = e), t && this._setSetting("FixedNavbarOption", e), window.Helpers.setNavbar(e), t && this.settings.onSettingsChange.call(this, this.settings));
                                    },
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        this._hasControls("contentLayout") &&
                                            ((this.settings.contentLayout = e), t && this._setSetting("contentLayout", e), window.Helpers.setContentLayout(e), t && this.settings.onSettingsChange.call(this, this.settings));
                                    },
                                },
                                {
                                    key: "setHeaderType",
                                    value: function (e) {
                                        ...
                                        if (this._hasControls("headerType") && ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].includes(e)) {
                                            (this.settings.headerType = e),
                                                ...
                                                window.Helpers.setPosition("fixed" === e || "fixed-offcanvas" === e, "static-offcanvas" === e || "fixed-offcanvas" === e),
                                            ...
                                            "fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType
                                                ? i && o && (window.Helpers.menuPsScroll.destroy(), (o = new i(document.querySelector(".menu-inner"), { suppressScrollX: !0, wheelPropagation: !1 })), (window.Helpers.menuPsScroll = o))
                                    ...
                                    value: function (e) {
                                        ...
                                        if (this._hasControls("showDropdownOnHover")) {
                                            if (((this.settings.showDropdownOnHover = e), t && this._setSetting("ShowDropdownOnHover", e), window.Helpers.mainMenu)) {
                                                ...
                                                var o = window.Menu;
                                                window.Helpers.mainMenu = new o(document.getElementById("layout-menu"), { orientation: "horizontal", closeChildren: !0, showDropdownOnHover: config.showDropdownOnHover });
                                            }
                                            t && this.settings.onSettingsChange.call(this, this.settings);
                                        }
                                    },
                                        ...
                                        if (!this._ssr) {
                                            ...
                                            this._controls.showDropdownOnHover &&
                                                ...
                                                this._controls.layoutNavbarOptions &&
                                                    ...
                                                    o && e && "fixed" === this.settings.headerType && (this._controls.layoutNavbarOptions.setAttribute("disabled", "disabled"), this._controls.layoutNavbarOptionsW.classList.add("disabled"))),
                                                ...
                                                this._controls.headerType && (t || o ? this._controls.headerType.removeAttribute("disabled") : this._controls.headerType.setAttribute("disabled", "disabled"));
                                        }
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        e || o || i || a || s || l || u || t || n ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1),
                                            ...
                                            t && (z = !0),
                                            (this.settings.color = t || this.settings.defaultPrimaryColor),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        if (this._hasControls("skins")) {
                                            ...
                                            var y = function (t) {
                                                document.documentElement.setAttribute("data-skin", t.target.value),
                                            ...
                                            if (this._hasControls("semiDark") && "dark" === this._getSetting("Theme")) _.classList.add("d-none");
                                                ...
                                                var S = function (t) {
                                                    var o = t.target.checked,
                                                        i = o ? "dark" : "light";
                                                    "dark" === i
                                                        ? (document.getElementById("layout-menu").setAttribute("data-bs-theme", i), document.documentElement.setAttribute("data-semidark-menu", "true"))
                                                        : (document.getElementById("layout-menu").removeAttribute("data-bs-theme"), document.documentElement.removeAttribute("data-semidark-menu")),
                                        ...
                                        if (this._hasControls("contentLayout headerType layoutCollapsed layoutNavbarOptions rtl", !0)) {
                                            ...
                                            if (this._hasControls("layoutNavbarOptions")) {
                                                ...
                                                var F = function (t) {
                                                    (e._loading = !0),
                                                        e._loadingState(!0, !0),
                                                        e.setLayoutNavbarOption(t.target.value, !0, function () {
                                                            (e._loading = !1), e._loadingState(!1, !0);
                                                        });
                                                };
                                        ...
                                        setTimeout(function () {
                                            ...
                                            "light" === document.documentElement.getAttribute("data-bs-theme") &&
                                                ...
                                                ("dark" === document.querySelector(".layout-menu").getAttribute("data-bs-theme") && (i = !0),
                                                ...
                                                document.querySelector(".menu-vertical")
                                                    ? e._hasControls("rtl contentLayout layoutCollapsed layoutNavbarOptions", !0) || (t && t.parentNode.removeChild(t))
                                                    : document.querySelector(".menu-horizontal") && (e._hasControls("rtl contentLayout headerType", !0) || (t && t.parentNode.removeChild(t)));
                                        }, 100),
                                ...
                                },
                                {
                                    key: "_getSkinByName",
                                    value: function (e) {
                                        for (var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = this.settings.availableSkins, i = 0, n = o.length; i < n; i++) if (o[i].name === e) return o[i];
                ...
                (D.COLORS = [
                    { name: "primary", title: "Primary", color: O.getPropertyValue("--bs-primary").trim() },
                    ...
                    (D.THEMES = [
                        { name: "light", title: "Light", image: '<i class="ri ri-sun-line icon-base mb-0"></i>' },
                        { name: "dark", title: "Dark", image: '<i class="ri ri-moon-clear-line icon-base mb-0"></i>' },
                        { name: "system", title: "System", image: '<i class="ri ri-computer-line icon-base mb-0"></i>' },
                    ]),
                    (D.SKINS = [
                    ...
                    !(function () {
                        ...
                        if (e.pickerWrapper && e.pickerEl) {
                            var t =
                                ...
                                o = new Pickr({ el: e.pickerEl, theme: "nano", default: t, defaultRepresentation: "HEX", comparison: !1, components: { hue: !0, preview: !0, interaction: { input: !0 } } });
                            o._root.button.classList.add("ri", "ri-palette-line"),
                                o.on("change", function (t) {
                                    var o,
                                        i = t.toHEXA().toString(),
                                        n = t.toRGBA().toString();
                                    null === (o = e.pcrButton) || void 0 === o || o.style.setProperty("--pcr-color", n),
                        ...
                        document.querySelector("#template-customizer").style.visibility = "hidden";
                    })();
